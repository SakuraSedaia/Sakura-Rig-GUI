...
# Layout
def LAYOUT_eyes(self, context, ui):
    ...
    # Interface
    # Eye Panel
    panel_eyes = ui.panel(idname=panels['eyes_config'])

    header = panel_eyes[0]
    header.label(text="Eyes")
    ...
    if panel is not None:
        ...
        row = panel.row()
        row.prop(face_prop, 'EYES_visual_style', expand=True)

        # TODO: remove the Section code and replace with the Controller Toggles
        row = panel.row()
